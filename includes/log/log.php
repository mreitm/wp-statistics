...
$widget_order = get_user_meta( \WP_STATISTICS\User::get_user_id(), 'meta-box-order_toplevel_page_wps_overview_page', true );

if ( is_array( $widget_order ) && count( $widget_order ) > 2 ) {
	delete_user_meta( \WP_STATISTICS\User::get_user_id(), 'meta-box-order_toplevel_page_wps_overview_page' );
}

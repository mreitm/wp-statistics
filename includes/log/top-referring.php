...
<div class="wrap wps-wrap">
    ...
    <ul class="subsubsub">
		<?php if ( $referr ) { ?>
            ...
            <li>
                <a class="current" href="?page=<?php echo \WP_STATISTICS\Menu::get_page_slug('referrers'); ?>&referr=<?php echo Referred::html_sanitize_referrer( $referr ) . $date_args; ?>"> <?php echo htmlentities( $title, ENT_QUOTES ); ?>

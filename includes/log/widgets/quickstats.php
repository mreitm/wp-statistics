...
function wp_statistics_generate_quickstats_postbox_content( $search_engines, $search = false, $time = false ) {
    ...
    <table width="100%" class="widefat table-stats" id="summary-stats">
		...
		<?php if ( WP_STATISTICS\Option::get( 'useronline' ) ) { ?>
            <tr>
                ...
                <th colspan="2" id="th-colspan">
                    <span><a href="<?php echo Admin_Menus::admin_url( 'online' ); ?>"><?php echo wp_statistics_useronline(); ?></a></span>
                </th>
            </tr>
		<?php }
		...
		if ( WP_STATISTICS\Option::get( 'visitors' ) || WP_STATISTICS\Option::get( 'visits' ) ) {
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 1 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'today', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 1 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'today' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 1 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'yesterday', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 1 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'yesterday' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 7 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'week', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 7 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'week' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 30 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'month', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 30 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'month' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 365 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'year', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 365 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'year' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
            ...
            <tr>
                ...
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visitors' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'visitors', array( 'hitdays' => 365 ) ) . '"><span>' . number_format_i18n( wp_statistics_visitor( 'total', null, true ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
                <th class="th-center"><?php if ( WP_STATISTICS\Option::get( 'visits' ) ) {
						echo '<a href="' . Admin_Menus::admin_url( 'hits', array( 'hitdays' => 365 ) ) . '"><span>' . number_format_i18n( wp_statistics_visit( 'total' ) ) . '</span></a>';
					} else {
						echo '';
					} ?></th>
            </tr>
	...
	include( WP_STATISTICS_DIR . "includes/log/widgets/hits.php" );
